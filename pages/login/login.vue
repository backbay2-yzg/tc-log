<template>
	<view class="page">
		<view class="tips-box"><u-notice-bar :text="tcNotice" speed="80"></u-notice-bar></view>
		<view class="login-box">
			...
			<u--form :model="form" ref="uForm" class="login-form">
				<u-form-item prop="username" class="loign-form-item"><u--input v-model="form.username" placeholder="请输入用户名" clearable adjustPosition></u--input></u-form-item>
...
import { getProjectNames, getDailyTaskTypes, getDailyReceives } from '@/api/writelog.js';

import { PROJECT_NAME_LIST, DAILY_TASK_TYPE_LIST, DAILY_RECEIVE_LIST, USER_INFO, ACCESS_TOKEN } from '@/common/constants.js';
export default {
	data() {
		return {
